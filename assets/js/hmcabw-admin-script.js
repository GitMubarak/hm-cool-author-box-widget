(function($) {
    ...
    $('form#hmcabw-general-settings-form').on('click', 'label', function(e) {
        e.preventDefault();
        var $check = $(this).prev();
    ...
    function Refresh_Image(the_id) {
        ...
        $.get(ajaxurl, data, function(response) {
            ...
            if (response.success === true) {
                ...
                $('#hmcabw-preview-image').replaceWith(response.data.image);
            }
        });
    }

    // Template settings
    $("form#hmcabw-template-settings-form").on('click', 'label', function(e) {
        e.preventDefault();
        var $check = $(this).prev();
